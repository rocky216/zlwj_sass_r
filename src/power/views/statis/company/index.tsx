...
class CompanyStatis extends React.Component<Props> {
  ...
  render() {
    ...
    return (
      <JCard spinning={spinning}> 
        <Card size="small" >
            ...
            tabBarExtraContent={(
              <div style={{marginBottom: "1px"}}>
                  ...
                  data={[
                    {name:"companyHe", type: <CompanyHeElement notHe />, rules:true},
                    {name: "type", type: (
        ...
        {activeKey==1 && companyHe?<PayStatis params={params} isChange={isChange} />:null}
        {activeKey==2 && companyHe?<OrderStatis params={params} isChange={isChange} />:null}
      </JCard>
    );
  }
}
...
export default connect(mapStateProps, mapDispatchProps)(CompanyStatis)