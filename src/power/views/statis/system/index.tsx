...
import PayStatis from "./paystatis"
import OrderStatis from "./orderstatis"
...
class SystemStatis extends React.Component<Props> {
  ...
  render() {
    ...
    const {dType, isChange, activeKey } = this.state
    ...
    return (
      <JCard spinning={spinning}> 
        ...
        {activeKey==1?<PayStatis params={params} isChange={isChange} />:null}
        {activeKey==2?<OrderStatis params={params} isChange={isChange} />:null}
      </JCard>
    );
  }
}
